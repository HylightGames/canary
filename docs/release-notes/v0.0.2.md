...
- **Not the parallel job-stealing scheduler.** The ECS now has the
  ...
  [`docs/architecture/core-runtime.md#threading--the-job-system`](../architecture/core-runtime.md#threading--the-job-system).
...
[`docs/roadmap/status.md`](../roadmap/status.md#v003-sequenced-not-deeply-scoped-yet),
